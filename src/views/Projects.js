...
const projects = [
  {
    ...
    'explores that space efficiently and decides what moves to make to defeat other bots. This uses a chess framework' +
    'and tests against bots by Stephen G. Ware.',
    links: [
      {
        label: 'Source',
